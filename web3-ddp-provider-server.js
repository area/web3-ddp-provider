Meteor.methods({
	'web3DdpProviderExec': function(call) {
		if (['eth_call', 'eth_sendRawTransaction', 'eth_newBlockFilter', 'eth_newFilter', 'eth_uninstallFilter', 'eth_getTransactionCount', 'eth_gasPrice', 'eth_getTransactionByHash','eth_estimateGas','eth_getBalance'].indexOf(JSON.parse(call).method) === -1) {
