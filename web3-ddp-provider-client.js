...
DdpProvider.prototype.sendAsync = function(payload, callback) {
	...
	if (['eth_call', 'eth_sendRawTransaction', 'eth_newBlockFilter', 'eth_newFilter', 'eth_uninstallFilter', 'eth_getTransactionCount', 'eth_gasPrice','eth_getTransactionByHash','eth_estimateGas', 'eth_getBalance'].indexOf(payload.method)===-1){
